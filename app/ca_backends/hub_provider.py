...
fehlschlägt, informiert das Gateway den Administrator — Sie selbst müssen nichts
veranlassen.</p>
"""
        # ⚠️ Kein Verweis auf den Selbstbedienungs-Upload: Die Bestellung läuft
        # über den Hub, der Postfachinhaber hat kein Zertifikat in der Hand. Der
        # Verweis stand hier bis 18.08.2026 und führte auf ein leeres Formular.
        # Begründung siehe castle_acme.py.
