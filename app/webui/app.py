...
from webui.deps import (                                    # noqa: E402
    log, security, templates, _STATIC_DIR, _TEMPLATE_DIR, _gateway_name,
    _NotAuthenticated, _hash_password, _verify_password, _check_password,
...
# ── Routenmodule ─────────────────────────────────────────────────────────────
# Erstes ausgelagertes Modul. `_addin_base_url` kommt von dort zurueck, weil es
# auch die Einstellungsseite braucht — der Import ist NICHT ringfoermig:
# routen/addin.py kennt nur webui.deps, nicht webui.app.
...
ROUTENMODULE = [_routen_addin, _routen_portal]
