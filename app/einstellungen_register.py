...
REGISTER: dict[str, E] = {
    ...
    "LE_DOMAIN": E(art=OPTION, ort="setup.html"),
    "LE_EMAIL": E(art=OPTION, ort="setup.html"),
    "LE_AUTO_RENEW": E(art=OPTION, ort="setup.html"),
    "LE_RENEW_DAYS": E(art=OPTION, ort="setup.html"),
    ...
    "RELAY_IDENT_DEFAULT_DOMAIN": E(art=OPTION, ort="relay.html"),
    ...
    "STRIP_CLIENT_SIGS_MOBILE": E(art=OPTION, ort="settings_signature.html"),
    "STRIP_CLIENT_SIGS_DESKTOP": E(art=OPTION, ort="settings_signature.html"),
