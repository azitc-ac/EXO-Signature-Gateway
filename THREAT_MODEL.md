...
| **Port 587** (Geräte/Apps → Gateway, Submission) | Sende-Identitäten mit eigenem Login | STARTTLS-**Pflicht** (Port öffnet nur mit TLS-Zertifikat, AUTH erst nach STARTTLS); Anmeldung gegen die Sende-Identitäten (Passwort-Hash pbkdf2, nie Klartext); **Anmelde-Bremse** je Quell-IP vor der Passwortprüfung (`login_drossel`, Backoff); Absenderdomäne muss dem Tenant gehören, Absender-Pin auf die Shared-Mailbox-Adresse, Ziel intern/extern je Identität; jede Anmeldung nur bei `SUBMISSION_ENABLED` |
